/**
 * Terms of Use -- locally hosted legal content.
 * Content sourced from theravoca.com/terms-of-use/ (last updated April 23, 2025).
 */
      ...
      <main className="flex-1 px-5 py-12 md:py-16" data-testid="terms-page">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-serif-display text-4xl sm:text-5xl text-[#2D4A3E] mt-2 leading-tight">
            TheraVoca Terms of Use &ndash; Patients
          </h1>
          ...
          <div className="mt-8 prose prose-sm max-w-none text-[#2B2A29] leading-relaxed space-y-6">
            ...
            {/* ── Intro ── */}
            <p>
              TheraVoca, LLC ("<strong>TheraVoca</strong>") provides TheraVoca.com and related online forms (together, the "<strong>Platform</strong>") to connect persons wishing to search for certain mental or behavioral health professionals (each a "<strong>Searcher</strong>"), on behalf of themselves or another individual (e.g., a friend or family member) (each, a "<strong>Patient</strong>"), with third-party professionals ("<strong>Therapists</strong>") who provide mental or behavioral health and therapy services ("<strong>Therapy Services</strong>").
            </p>
            <p>
              These Terms of Use (the "<strong>Terms</strong>") govern the Searcher's access to and use of the Platform. These Terms also govern our services made available to Searchers on or through the Platform (the "<strong>TheraVoca Services</strong>", and together with the Platform, the "<strong>Services</strong>"). These Terms are a binding legal agreement between you and TheraVoca ("<strong>we</strong>", "<strong>us</strong>", and "<strong>our</strong>"). All references to "you" or "your", as applicable, mean collectively, the Searcher who accesses or uses the Services in any manner and the Patient (if different from the Searcher) and each of your heirs, assigns and successors.
            </p>
            <p>
              These Terms do not govern Therapists' use of the Services in their capacity as Therapists &mdash; any access or use of the Services by a Therapist is governed by our{" "}
              <a href="/terms/therapist" className="text-[#2D4A3E] underline">Therapist Terms of Use</a>.
            </p>
            <p>
            ...
            <section>
              ...
              <p>
                By accessing, using, or interacting with the Services, you are indicating that you have read, understand, and agree to be bound by these Terms, and you consent to our collection and other handling of information as described in our{" "}
                <a href="/privacy" className="text-[#2D4A3E] underline">Privacy Policy</a>.
                {" "}If you do not agree to be bound by these Terms or any provisions hereof, please do not access or use the Services.
              </p>
              <p className="mt-3">
                In order to use certain parts of the Services, you may be required to provide certain information about yourself and/or the Patient for which you are registering. You are responsible for ensuring that all required registration information you submit is truthful and accurate, and that your contact information (including email address and phone number, as applicable) is current. In the event you are required to create an account with us to access and use the Services (a "<strong>User Account</strong>"), you are solely responsible for maintaining the confidentiality and security of your User Account login information. You agree not to share your login credentials or access to your User Account with anybody or to create more than one account. We are not liable for any losses incurred by you or any party as a result of unauthorized use of your User Account. You agree to notify us immediately of any unauthorized use of your User Account.
              </p>
              <p className="mt-3">
            ...
            <section>
              ...
              <p className="mt-3">
                When you submit, upload, publish, or transmit User Content as part of your use of the Platform, TheraVoca will use your User Content for the TheraVoca Services to provide matches with Therapists that may meet your search criteria. As a result of the TheraVoca Services, you will receive personalized search results generated or produced in connection with your User Content ("<strong>Output</strong>"). Such Output will include a list of Therapists and their respective contact information so that you may communicate outside of the Platform with such Therapists.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <em>License Grant.</em> Subject to the terms and conditions herein, we grant you a limited, non-exclusive, non-transferable, non-sublicensable revocable license to access and use the Services solely for the permitted uses described herein. No licenses or rights are granted to you by implication or otherwise under any intellectual property rights owned or controlled by us or our licensors, except for the licenses and rights expressly granted in these Terms.
              </p>
              <p className="mt-3">
                <em>Reservation of Rights.</em> As between you and TheraVoca, the Services, including without limitation any content, data, organization, graphics, design, compilation, magnetic translation, sound, artwork, computer code, digital conversion, logos, names, patents, trademarks, service marks, product and service names, slogans, copyrights, and all the intellectual property rights therein or relating thereto, are and shall remain the exclusive property of TheraVoca or its licensors (as applicable). Nothing in these Terms shall be interpreted to provide you with any rights in the foregoing, except the limited right to use the Services expressly set forth herein.
              </p>
              <p className="mt-3">
                <em>License to User Content.</em> When you submit User Content to or through the Platform, you grant TheraVoca a worldwide, perpetual, irrevocable, royalty-free, non-exclusive, and sub-licensable license to use, copy, cache, distribute, reproduce, modify, edit, adapt, publicly perform, publicly display, translate, create derivative works from, sell, lease, transmit, communicate to the public, disassemble, and publish such User Content, in whole or in part, in any format or medium now known or hereafter devised, without compensation to you, for purposes of performing the Services.
              </p>
              <p className="mt-3">
                <em>Feedback.</em> From time to time, you may provide us with comments, suggestions, or ideas for enhancements, improvements, changes, or additions to the Services or our business in general, including ideas for new features, materials, and other content ("<strong>Feedback</strong>"). By providing us Feedback, you grant to us exclusive ownership of the Feedback and of all intellectual property rights and other rights in it, and you will provide us with reasonable cooperation in documenting this grant. TheraVoca has no obligation to do anything with Feedback, but we will have the full, worldwide, unencumbered right to use, incorporate, and otherwise fully exercise and exploit any such Feedback via all forms of media, distribution methods, and technology now known or later developed, for any purposes, commercial or otherwise, and to transfer or license our rights in the Feedback, without notice, acknowledgement or compensation to you.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We respect the intellectual property of others, and we ask you to do the same. It is not our intent to infringe on the intellectual property rights of others, and we will respond to allegations of copyright infringement in accordance with the Digital Millennium Copyright Act (17 U.S.C. &sect; 512) ("<strong>DMCA</strong>"). It is our policy to terminate the accounts of repeat infringers in appropriate circumstances. If you believe that your copyrighted materials has been copied in a way that constitutes copyright infringement, please provide us with a written notice ("<strong>DMCA Notice</strong>") with the following information:
              </p>
              <ol className="list-decimal pl-5 mt-2 space-y-1">
                ...
                <li>Identification of the material that is claimed to be infringing and where it is located in or on the Services;</li>
                <li>Information reasonably sufficient to permit TheraVoca to contact you, such as your address, telephone number, and e-mail address;</li>
              ...
              <p className="mt-3">
                The fastest way to submit a DMCA Notice to us is by emailing our copyright agent at{" "}
                <a href="mailto:copyright@theravoca.com" className="text-[#2D4A3E] underline">copyright@theravoca.com</a>,
                {" "}with the subject line "COPYRIGHT INFRINGEMENT". Please note that we may request additional information before removing any allegedly infringing material. The full contact details of our copyright agent are:
              </p>
            ...
            <section>
              ...
              <p className="mt-3">
                We reserve the right, at our own expense, to assume the exclusive defense and control of such disputes, and in any event you will cooperate with us in asserting any available defenses. You will not settle or compromise any such claim without our prior written consent.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                <em>Entire Agreement.</em> These Terms constitute the entire agreement between you and TheraVoca, and supersede any prior and contemporaneous agreements between you and TheraVoca on the subject matter.
              </p>
              <p className="mt-3">
                <em>Force Majeure.</em> Under no circumstances will TheraVoca be liable for any delay or failure in performance resulting directly or indirectly from an event beyond its reasonable control.
              </p>
              <p className="mt-3">
                <em>Statute of Limitations.</em> You agree that regardless of any statute or law to the contrary, any claim or cause of action arising out of or related to the use of the Services, or the Terms, must be filed within one (1) year after such claim or cause of action arose or be forever barred.
              </p>
              <p className="mt-3">
                <em>No Waiver.</em> No waiver of any term of these Terms shall be deemed a further or continuing waiver of such term or any other term, and TheraVoca's failure to assert any right or provision under these Terms shall not constitute a waiver of such right or provision.
              </p>
              <p className="mt-3">
                <em>Severability.</em> Each of the provisions of these Terms operates separately. If any court or relevant authority decides that any of them are unlawful or unenforceable, the remaining provisions will remain in full force and effect. In the event that any provision is deemed unlawful or unenforceable, you and TheraVoca agree that such provision shall be modified or amended by the court or relevant authority to the extent necessary to render it enforceable, in accordance with the intent of the original provision. The modified provision shall be interpreted so as to reflect the original intent of the parties as closely as possible, while remaining compliant with applicable law.
              </p>
              <p className="mt-3">
                <em>Third-party beneficiaries.</em> Except as otherwise expressly provided in these Terms, there shall be no third-party beneficiaries to these Terms.
              </p>
              <p className="mt-3">
                <em>No agency.</em> No agency, partnership, joint venture or employee-employer relationship is intended or created by these Terms, and you shall have no right or authority to assume or create any obligations or to make any representations on behalf of TheraVoca, or to bind TheraVoca in any respect.
              </p>
              <p className="mt-3">
                <em>Assignment.</em> These Terms, and any rights and licenses granted hereunder, may not be transferred or assigned by you without the prior written consent of TheraVoca. Any attempted transfer or assignment in violation hereof shall be null and void.
              </p>
              <p className="mt-3">
                <em>Electronic processing.</em> You agree that any agreements made by and between you and us in electronic form are as legally binding as if made in physical written form.
              </p>
              <p className="mt-3">
                <em>Headings.</em> Headings and subheadings in these Terms are for convenience only and have no legal or contractual effect.
              </p>
            </section>
