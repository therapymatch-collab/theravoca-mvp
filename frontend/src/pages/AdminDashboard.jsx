...
function OptOutsPanel({ data, loading, onReload, filter }) {
...
function ProfileCompletionPanel({ data, client, onReload, filter }) {
...
function PatientsByEmailPanel({ data, filter, onReload }) {
