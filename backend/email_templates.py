...
DEFAULTS: dict[str, dict[str, str]] = {
    ...
    "patient_followup_3w": {
        "title": "Patient follow-up — 3 weeks after matches",
        "description": "Selection + first impressions survey 21 days after matches.",
        "subject": "Three weeks in — how did your TheraVoca match work out?",
        "heading": "Checking in on your match",
        "greeting": "Hi there,",
        "intro": "It's been about three weeks since we sent your therapist matches. Whether you've started sessions or are still deciding, we'd love to hear how it's going.",
        "cta_label": "Share your update (under 60 seconds)",
    ...
    "patient_followup_9w": {
        ...
        "greeting": "Hi there,",
        "intro": "It's been about two months since we connected you with your therapist. We'd love to hear how the relationship is developing — your feedback helps us make better matches.",
    ...
    "patient_followup_15w": {
        "title": "Patient follow-up — 15 weeks after matches",
        "description": "Final outcome survey 15 weeks after matches — progress + referral willingness.",
        "subject": "Fifteen weeks in — your TheraVoca outcome",
        "heading": "Final check-in",
        "greeting": "Hi there,",
        "intro": "It's been a few months since we matched you with a therapist. This is our last check-in — we'd love to know how things have turned out.",
