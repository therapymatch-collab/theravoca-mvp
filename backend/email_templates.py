...
DEFAULTS: dict[str, dict[str, str]] = {
    ...
    "therapist_signup_received": {
        ...
        "greeting": "Hi {first_name},",
        "intro": "Thank you for joining the TheraVoca network. We've received your profile and our team will review it shortly. Most profiles are approved within 1–2 business days.",
        "cta_label": "",
        "footer_note": "Once approved, you'll start receiving anonymous referral notifications matched to your specialties — no logins, no marketing fluff. Just real patients who need your help.",
